...
- `sentry.sdk.name`: The name of the SDK that sent the log (e.g., `sentry.javascript.browser`, `sentry.javascript.node`)
...
For server-side JavaScript applications (Node.js, Bun, Deno, etc.):
